...
export const EXPERIENCE_CONFIG: Record<string, ExperienceConfig> = {
  ...
  msmes: {
    hero: "light", icon: "Briefcase", eyebrow: "For MSMEs",
    headline: "Recover dues,", accent: "protect cash flow",
    primary: { label: "Lodge a dispute", href: "/lodge-dispute" },
    secondary: { label: "Talk to an expert", href: "/talk-to-us" },
    panelTitle: "Built for small business", panelLead: "Keep working capital moving with fast recovery.",
    highlights: [
      { icon: "Banknote", title: "Faster recovery", text: "Resolve payment disputes in 60 days." },
      { icon: "TrendingUp", title: "Protect cash flow", text: "Stop bad debt from stalling growth." },
      { icon: "ShieldCheck", title: "Enforceable", text: "Binding awards you can act on." },
    ],
    closeHeading: "Keep your business moving",
    closeText: "Resolve MSME disputes quickly and protect your bottom line.",
  },
  "financial-institutions": {
    hero: "dark", icon: "Landmark", eyebrow: "For Financial Institutions",
    headline: "Recovery at", accent: "scale",
    primary: { label: "Talk to our team", href: "/contact" },
    secondary: { label: "View pricing", href: "/pricing" },
    panelTitle: "Trusted by banks & NBFCs", panelLead: "Digital dispute resolution for high-volume recovery.",
    highlights: [
      { icon: "Landmark", title: "Banks & NBFCs", text: "Trusted by 70+ institutions across India." },
      { icon: "Zap", title: "High volume", text: "Thousands of disputes, resolved digitally." },
      { icon: "ShieldCheck", title: "Compliant", text: "Fully aligned with the regulatory framework." },
    ],
    closeHeading: "Scale your recovery operations",
    closeText: "Partner with PDR COURT for fast, compliant, high-volume resolution.",
  },
  enterprise: {
