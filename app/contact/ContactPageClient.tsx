            ...
            >
              ...
              <div className="relative grid lg:grid-cols-[1.4fr_1fr] gap-10 items-center">
                <div>
                  ...
                  <p className="mt-4 text-dark/70 leading-relaxed max-w-xl">
                ...
                <div className="lg:text-right">
                  <div className="inline-flex flex-col items-start lg:items-end gap-4">
                    <span className="inline-flex items-center gap-2 text-sm text-dark/55">
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-dark/55 mt-0.5">{s.text}</p>
                    </div>
