...
import { ShieldCheck, Heart, Award, ArrowRight, HeartHandshake } from 'lucide-react';
...
export default function ConciliatorClientPage() {
  const responsibilities = [
    "Helping establish a mutual agreement in disputes.",
    "Hearing the parties involved and clarifying the argument details.",
    "Explaining the conciliation process to the parties involved.",
    "Scheduling appointments with both parties.",
    "Promoting open discussion and encouraging compromise between both the parties.",
    "Making a non-binding proposal for settlement after hearing both sides.",
    ...
    <div className="bg-cream min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-primary-300 text-sm font-medium mb-8">
                ...
                <span>Empanelment & Careers</span>
              </div>
              
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-bold text-white mb-6 leading-tight">
                Conciliation at <br/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-amber-200">PDR COURT</span>
              </h1>
              
              <p className="text-lg md:text-xl text-white/70 leading-relaxed font-light mb-10 max-w-lg">
                Conciliation serves as the bridge of trust and mutual respect in commercial dispute resolution. PDR COURT invites professional conciliators and mediators to join our panel.
              </p>
              
              <a href="#apply-section" className="btn-primary">
                Join Panel of Conciliators
              </a>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.2 }} className="hidden lg:block">
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-10 rounded-3xl relative overflow-hidden">
                ...
                <h3 className="text-2xl font-display font-bold text-white mb-4 relative z-10">Mutual Respect</h3>
                <p className="text-white/60 mb-6 relative z-10 leading-relaxed">
                  Help parties reach common ground without lengthy and destructive court proceedings. Utilize high-fidelity technology to manage document submissions and proposals.
                </p>
      ...
      <div id="apply-section">
        <CareerApplicationForm 
          role="Conciliator"
          description="PDR COURT conciliators play an active role in resolving disputes by guiding the parties with appropriate settlement terms and offering expert legal proposals in a confidential, professional, and efficient framework."
      ...
      <div className="bg-white border-t border-cream-300">
        <SiblingLinksSection 
          links={[
            { title: "Arbitrator", route: "/careers/arbitrator", description: "Empanel as an independent arbitrator." },
            { title: "Case Manager", route: "/careers/case-manager", description: "Bridge disputes as a case manager." }
          ]} 
          parentRoute="/" 
          currentRoute="/careers/conciliator" 
          kind="Careers" 
        />
      </div>
    </div>
