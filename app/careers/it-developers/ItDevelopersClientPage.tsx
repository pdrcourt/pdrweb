...
import { ShieldCheck, Heart, Award, ArrowRight, Code } from 'lucide-react';
...
export default function ItDevelopersClientPage() {
    ...
    <div className="bg-cream min-h-screen">
      ...
      <div id="apply-section">
        <CareerApplicationForm 
          role="IT Developer"
          description="At PDR COURT, we leverage cutting-edge technology and software solutions to transform standard ADR. Join us as an independent developer to build robust, highly secure, and intuitive applications."
      ...
      <div className="bg-white border-t border-cream-300">
        <SiblingLinksSection 
          links={[
            { title: "ERP Manager", route: "/careers/erp-management", description: "Optimize operations and software flows." },
            { title: "Resources", route: "/resources", description: "Explore templates, legal clauses, and resources." }
          ]} 
          parentRoute="/" 
          currentRoute="/careers/it-developers" 
          kind="Careers" 
        />
      </div>
    </div>
