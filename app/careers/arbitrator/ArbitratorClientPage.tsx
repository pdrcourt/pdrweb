...
import { ShieldCheck, Heart, Award, ArrowRight, Gavel } from 'lucide-react';
...
export default function ArbitratorClientPage() {
  const responsibilities = [
    ...
    "Making a non-binding decision after hearing both sides.",
    ...
    <div className="bg-cream min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-bold text-white mb-6 leading-tight">
                Arbitration at <br/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-amber-200">PDR COURT</span>
              </h1>
              
              <p className="text-lg md:text-xl text-paper-70 leading-relaxed font-light mb-10 max-w-lg">
                Arbitration is gaining global recognition, acceptance, and trust as a solution for resolving disputes. PDR COURT invites you to join our Expert Panel of Arbitrators and showcase your expertise through our innovative platform.
              </p>
              
              <a href="#apply-section" className="btn-primary">
                Join Panel of Arbitrators
              </a>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.2 }} className="hidden lg:block">
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-10 rounded-3xl relative overflow-hidden">
                ...
                <h3 className="text-2xl font-display font-bold text-white mb-4 relative z-10">Institutional Panel</h3>
                <p className="text-paper-60 mb-6 relative z-10 leading-relaxed">
                  Join a community of elite mediators, legal counsel, and business dispute experts utilizing industry-leading technology to settle domestic and international disputes.
                </p>
      ...
      <div id="apply-section">
        <CareerApplicationForm 
          role="Arbitrator"
          description="At PDR COURT, our expert arbitrators utilize advanced technology tools to enhance the efficiency of dispute resolution, gaining global trust and recognition. In your role, you will analyze arguments, review evidence, and render fair, professional judgments."
      ...
      <div className="bg-white border-t border-cream-300">
        <SiblingLinksSection 
          links={[
            { title: "Join Us", route: "/join-us", description: "Careers at PDR COURT." },
            { title: "Conciliator", route: "/careers/conciliator", description: "Facilitate mutually agreed settlements." }
          ]} 
          parentRoute="/" 
          currentRoute="/careers/arbitrator" 
          kind="Careers" 
        />
      </div>
    </div>
